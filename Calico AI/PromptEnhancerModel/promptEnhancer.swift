...
class promptEnhancer {
    ...
    private let model = try! magicPrompter()
    ...
    func predict(tokens: [Int]) -> Int {
        ...
        //------from chad gpt------------------
//        let input_ids = try! MLMultiArray(
//            shape: [1, NSNumber(value: seqLen)],
//            dataType: .int32
//        )
//        //
//        for (i, value) in (maxTokens + Array(repeating: 0, count: seqLen - maxTokens.count)).enumerated() {
//            input_ids[i] = NSNumber(value: value)
//        }
        //---------------from chad gpt-----------
